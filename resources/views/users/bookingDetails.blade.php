            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('user.signContract', $booking->bookingID) }}" method="POST" id="form">
                        ...
                        <span> <input type="checkbox" name="valid" class="inputs">I have read the contract and i agree on
                            signing it.</span>
                        <br>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="link link-danger"
                        onclick="document.querySelector('#form1').submit()">DECLINE
                        CONTRACT</button>
                </div>
            </div>
        </div>
            ...
            @elseif($booking->state == 'DECLINED')
                ...
                <div class="booking">
                    <div class="content">
                        ...
                        <strong class="d-block text-center mb-4 danger">This booking has been refused by the
                            agency</strong>
            ...
            @else
                ...
                <div class="d-flex justify-content-center">
                    @if ($booking->state == 'ACCEPTED')
                        ...
                        <a href="{{ $booking->contractUrl }}" class="link link-underline m-2">Download
                            Contract</a>
                        <button class="link link-underline m-2" data-bs-toggle="modal"
                ...
                <div class="d-flex justify-content-center">
                    @if ($booking->state == 'ACCEPTED')
                        ...
                        {{-- <a href="{{ route('user.downloadPdf', $booking->bookingID) }}" --}}
                        <a href="{{ $booking->contractUrl }}" class="link link-underline m-2">Download
                            Contract</a>
                        <button class="link link-underline m-2" data-bs-toggle="modal"
                            data-bs-target="#exampleModal">Sign

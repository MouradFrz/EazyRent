...
@section('content')
    <div class="m-0 email-alert">
        <div class="container border-start border-warning border-3">
            This platform is made for demonstration purposes only.<br> The vehicles presented on the website do not exist in
            real life.
        </div>
    </div>
    <div class="hero">
                ...
                <div class="hero_content header col-12 col-lg-6">
                    ...
                    <div class="search-panel" id="search-form">
                        <form action="{{ route('user.viewOffers') }}" method="GET">
                            ...
                            <input type="date" name="" class='inputs' id="mydate" placeholder="Select date"
                                onchange="fillFields()">
                            @error('dropOffDate')
                                <span class="danger">{{ $message }}</span>
                            @enderror
                            ...
                            <button type="submit" class="custom-btn custom-btn-dark mt-4"><i
    ...
    <div id="whoUs" class="who-us header section">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    <p><span>EazyRent</span> is a platform that makes renting your next vehicle a simple task in an easy,
                        fast and
                        secure way.
                        <br><br>
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <blockquote>
                            ...
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas consequatur ut voluptatum
                            inventore quis
                            cumque ad atque omnis aut doloremque error, deleniti maxime distinctio velit? Delectus quae
                            magni suscipit
                            tempora?

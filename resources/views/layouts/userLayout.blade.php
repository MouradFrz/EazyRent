...
<body>
            ...
            <div class="d-flex align-items-center">
                @if (Illuminate\Support\Facades\Route::current()->getName() === 'user.home' ||
                    ...
                    <button id="navbar-toggler"class="navbar-toggler" type="button" data-bs-toggle="collapse"
                        ...
                        style="box-shadow: none;padding:.5rem;margin-right:.5rem;border:0;">
            ...
            @auth
                <div class="auth dropdown">
                    @if (!is_null(Auth::user()->profilePath))
                        <img src="{{ Auth::user()->profilePath }}" alt="{{ Auth::user()->username }}" id="user-icon">
                    @else
                    ...
                    <a class="dropdown-toggle" href="#" id="notificationsDropdown" role="button"
  ...
  @endauth --}}
    ...
    <script>
        ...
        $.get(`{!! route('user.loadNotifications') !!}`, function(data) {
            if (data.length === 0) {
                ...
                data.forEach((e) => {
                    const url = `{!! route('user.bookingDetails', ['id' => ' ']) !!}`.slice(0, -3) + e.bookingID
                    let a = document.createElement('a')
                    a.href = url

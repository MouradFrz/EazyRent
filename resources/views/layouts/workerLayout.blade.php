        ...
        <aside class="sidebar col-4 col-md-3 col-xl-2">
            ...
            @if (Auth::guard('admin')->check())
                <ul class="nav flex-column align-items-center justify-content-center">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.getAgencies') }}" class="nav-link "><i
                                class="fa-regular fa-warehouse"></i>Agencies list</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('admin.usersList') }}" class="nav-link "><i
                                class="fa-solid fa-users"></i>Users list</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('admin.loadBans') }}" class="nav-link "><i
                                class="fa-solid fa-ban"></i>Banned users</a>
                    </li>
                </ul>
            @endif
            @if (Auth::guard('owner')->check())
                <ul class="nav flex-column align-items-center justify-content-center">
                    ...
                    <li class="nav-item active">
                        <a id="clientComplaints" href="{{ route('owner.showReclamations') }}"
                            class="nav-link"><i class="fa-solid fa-comment"></i>Client complaints</a>
                    </li>
                </ul>
            @endif
            @if (Auth::guard('garagist')->check())
                <ul class="nav flex-column align-items-center justify-content-center">
                    <li class="nav-item">
                        <a href="{{ route('garagist.vehicles') }}" class="nav-link active"><i
                                class="fa-solid fa-car-side"></i>Vehicle management</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('garagist.getReservations') }}" class="nav-link "><i
                                class="fa-solid fa-rectangle-list"></i>On going reservations</a>
                    </li>
                </ul>
            @endif
            @if (Auth::guard('secretary')->check())
                <ul class="nav flex-column align-items-center justify-content-center">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('secretary.getReservationRequests') }}" class="nav-link "><i
                                class="fa-solid fa-rectangle-list"></i></i>reservation requests</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('secretary.showVehicules') }}" class="nav-link "><i
                                class="fa-solid fa-car-side"></i>Vehicules management</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('secretary.getPickUpLocations') }}" class="nav-link "><i

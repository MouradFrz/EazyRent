  ...
  <div class="modal fade" id="unbanUser" tabindex="-1" aria-labelledby="unbanUserLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
          <button type="button" class="btn btn-success" onclick="document.querySelector('#unban').submit()">Confirm</button>
        </div>
      </div>
    </div>
  </div>
    ...
    @endif
            <h2 class="py-3">Agency bans list</h2>
            <hr>
            <table class="table table-striped" id="usersList">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><button class="btn btn-danger btn-sm banbtn" data-fullname="{{ $ban->firstName }} {{ $ban->lastName }}" data-un="{{ $ban->username }}" data-bs-toggle="modal" data-bs-target="#banUser">Ban</button></td>
                  </tr>
                  @endforeach
                </tbody>
              </table>
              ...
              <h2 class="py-3">Banned users list</h2>
            <hr>
            <table class="table table-striped" id="bansList">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><button class="btn btn-success btn-sm unbanbtn" data-fullname="{{ $ban->firstName }} {{ $ban->lastName }}" data-un="{{ $ban->username }}" data-bs-toggle="modal" data-bs-target="#unbanUser">Unban</button></td>
                  </tr>
                  @endforeach
                </tbody>
              </table>

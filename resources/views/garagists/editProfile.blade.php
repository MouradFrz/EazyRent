...
@section('content')
    ...
    <div class="create-agency mt-5">
        <div class="container">
            ...
            <h2>Profile </h2>
            <hr>
            <form method="POST" action="{{ route('garagist.editProfile') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col d-flex flex-column">
                        @if (!is_null(Auth::user()->profilePath))
                            <img src="{{ Auth::user()->profilePath }}"
                                alt="" style="width: 150px;border-radius:50%;" class="image-change mb-3">
                            <button class="btn btn-primary image-selector-open" style="width: 150px;">Change profile
                                picture</button>
                        @else
                            <img src="{{ asset('images/download.png') }}" alt=""
                                style="width: 150px;border-radius:50%;" class="image-change mb-3">
                            <button class="btn btn-primary image-selector-open" style="width: 150px;"> Add profile
                                picture</button>
                        @endif
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="text" name="phone" class="form-control" maxlength="10"
                                placeholder="Phone number" value="{{ Auth::user()->phoneNumber }}" disabled
                    ...
                    <small class="text-muted ">Leave the new password field empty if you want to keep the same password.
                        *</small>
                    <div class="row">
                        <div class="col">
                        ...
                        <div class="col">
                            ...
                            <input type="password" name="passwordConfirm" class="form-control"
                                placeholder="Confirm password" value="" disabled>
                    ...
                    <div class="row d-flex justify-content-end">
                        <div class="col-6">
                            ...
                            <input type="password" name="currentPassword" class="form-control"
                                placeholder="Current password" value="" disabled>

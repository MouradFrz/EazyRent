    ...
    <form method="POST" action="{{route('owner.editProfile')}}" enctype="multipart/form-data">
      ...
      <div class="row">
        <div class="col d-flex flex-column">
          ...
          @else
          <img src="{{ asset('images/download.png') }}" alt="" style="width: 150px;border-radius:50%;"
            class="image-change mb-3">
      ...
      <div class="row">
        ...
        <div class="col">
          ...
          <input type="text" name="idCard" class="form-control" maxlength="18" placeholder="Identity card number"
            value="{{ Auth::user()->idCard }}" disabled onkeypress="return isNumber(event)">
          @error('idCard')
          <p style="color:red">{{ $message }}</p>
          @enderror
        </div>
      ...
      <div class="row">
        <div class="col">
          ...
          <input type="text" name="phone" class="form-control" maxlength="10" placeholder="Phone number"
            value="{{ Auth::user()->phoneNumber }}" disabled onkeypress="return isNumber(event)">
          @error('phone')
          <p style="color:red">{{ $message }}</p>
          @enderror
        </div>
      ...
      <div class="row">
        ...
        <div class="col">
          ...
          <input type="password" name="passwordConfirm" class="form-control" placeholder="Confirm password" value=""
            disabled>
      ...
      <div class="row d-flex justify-content-end">
        <div class="col-6">
          ...
          <input type="password" name="currentPassword" class="form-control" placeholder="Current password" value=""
            disabled>

  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Are you sure you want to delete this garage ? <br> <span style="color:red"> The garage manager that's
            currently managing this garage will be available for other garages of this branch. </span></p>
      </div>
      <div class="modal-footer">
        ...
        <button type="button" class="link link-danger"
          onclick="document.querySelector('#deleteForm').submit()">Confirm</button>
...
<div>
  <div class="container">
    ...
    <button class="link link-secondary" data-bs-toggle="modal" data-bs-target="#changeManager">Change garage
      manager</button>
